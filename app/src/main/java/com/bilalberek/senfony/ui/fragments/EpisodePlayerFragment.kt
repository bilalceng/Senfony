...
import com.bilalberek.senfony.service.SenfonyMediaCallback
import com.bilalberek.senfony.service.SenfonyMediaCallback.Companion.CMD_CHANGE_SPEED
import com.bilalberek.senfony.service.SenfonyMediaCallback.Companion.CMD_EXTRA_SPEED
...
class EpisodePlayerFragment : Fragment() {
            ...
            mediaPlayer?.let { mediaPlayer ->
                ...
                mediaPlayer.setOnPreparedListener {
                    ...
                    mediaSession?.let { mediaSession ->
                        val episodeMediaCallback = SenfonyMediaCallback(fragmentActivity, mediaSession, it)
    ...
    private fun startPlaying(episodeViewData: PodcastViewModel.EpisodeViewData) {
        ...
        bundle.putString(MediaMetadataCompat.METADATA_KEY_ALBUM_ART_URI, viewData.value?.imgUrl)
    ...
    private fun initMediaBrowser() {
        ...
        mediaBrowser = MediaBrowserCompat(fragmentActivity,
            ComponentName(fragmentActivity, SenfonyMediaService::class.java),
